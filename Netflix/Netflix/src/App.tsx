...
//               Netflix est un service de streaming vidéo par abonnement
//               offrant une vaste gamme de films, séries télévisées et autres
//               contenus originaux et sous licence. Son modèle économique
//               repose sur des abonnements mensuels, offrant différents
//               niveaux d'accès en fonction du prix. En plus de cela, Netflix
//               génère des revenus grâce à ses productions originales, à la
//               publicité et à des partenariats de contenu.
//             </div>
//           </div>
//         </div>
//       </div>
...
//             </div>
//             <div className="mt-7 text-lg leading-7 text-justify max-md:max-w-full">
//               Netflix tire parti des avancées technologiques dans le
//               streaming vidéo, de l'ubiquité de l'accès à Internet et de la
//               prolifération des appareils connectés pour fournir un
//               divertissement à la demande à ses abonnés. Son algorithme de
//               recommandation basé sur l'apprentissage automatique et
//               l'analyse des données permet de personnaliser l'expérience de
//               visionnage pour chaque utilisateur, favorisant ainsi
...
//       <div className="my-auto text-xl font-medium text-white">
//         Publicité
//       </div>
...
//           </div>
//           <div className="mt-7 text-lg leading-7 text-justify max-md:max-w-full">
//             Pour promouvoir un numérique plus éthique, Netflix pourrait
//             investir dans la diversification de ses contenus pour mieux
//             représenter la diversité culturelle, ethnique et sociale. De
//             plus, l'entreprise pourrait adopter des pratiques de production
//             plus durables et écologiques, ainsi que renforcer ses mesures de
//             protection de la vie privée des utilisateurs pour garantir une
...
//     À ce jour, Netflix compte plus de 200 millions d'abonnés dans le monde,
//     ce qui en fait l'un des principaux acteurs du marché du streaming vidéo.
//     <br />
//   </div>
...
//       <span className="text-red-600"> Milliards</span> de dollars durant
//       l’année 2022
//     </div>
//     <div className="flex-auto">
//       <span className="text-4xl text-red-600">+25%</span> du marché du
//       streaming vidéos
//     </div>
//   </div>
